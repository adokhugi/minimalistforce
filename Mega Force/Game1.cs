...
namespace WindowsGame2
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        const int MEMBERMENU_NUMCHARSPERPAGE = 7;
        ...
        {
            Map.Texture = this.Content.Load<Texture2D>("mini_white");
            ...
            Spell.TextureRecruit = this.Content.Load<Texture2D>("mini_spells_recruit");
            ...
            Character.TexturesJacob = this.Content.Load<Texture2D>("mini_party_hero");
            Character.TexturesCaryn = this.Content.Load<Texture2D>("mini_party_healer");
            Character.TexturesTassi = this.Content.Load<Texture2D>("mini_party_warrior");
            Character.TexturesEva = this.Content.Load<Texture2D>("mini_party_archer");
            Character.TexturesHans = this.Content.Load<Texture2D>("mini_party_warrior");
            Character.TexturesMonica = this.Content.Load<Texture2D>("mini_party_mage");

            Character.TexturesNeutralTassi = this.Content.Load<Texture2D>("mini_neutral_warrior");
            Character.TexturesNeutralEva = this.Content.Load<Texture2D>("mini_neutral_archer");
            Character.TexturesNeutralMonica = this.Content.Load<Texture2D>("mini_neutral_mage");

            Character.TexturesNinja = this.Content.Load<Texture2D>("mini_enemies_archer");
            Character.TexturesBanana = this.Content.Load<Texture2D>("mini_enemies_warrior");
            Character.TexturesWitch = this.Content.Load<Texture2D>("mini_enemies_mage");
            Character.TexturesSamurai = this.Content.Load<Texture2D>("mini_enemies_healer");

            TitleScreen.Texture = this.Content.Load<Texture2D>("mini_titlescreen");

            largeCharacterStatsMainBox.Size = new Vector2(600, 414);
            // 2024.12.02 introduced constants
            largeCharacterStatsMainBox.Position = new Vector2((Game1.PREFERREDBACKBUFFERWIDTH - largeCharacterStatsMainBox.Size.X) / 2, (Game1.PREFERREDBACKBUFFERHEIGHT - largeCharacterStatsMainBox.Size.Y) / 2);
        ...
        private void SetUpInitialParty()
        {
            ...
            warrior = new Character("WARRIOR");
            archer = new Character("ARCHER");
            knight = new Character("WARRIOR");
            mage = new Character("WIZARD");

            // temporarily the party consists only of jacob, caryn and tassi
            party = new Party(CharacterPointer.Sides.Player);
            party.Members.Add(hero);
            party.Members.Add(healer);
            party.Members.Add(warrior);
            party.Members.Add(archer);
            party.Members.Add(knight);
        ...
        private CharacterPointer CalculateCharacterPointersForThisBattle(Party[] parties)
        {
            ...
            while (parties_numSet[0] < parties[0].Members.Count || parties_numSet[1] < parties[1].Members.Count)
            {
                highest = null;
                for (j = 0; j <= 1; j++)
                {
                    for (i = 0; i < parties[j].Members.Count; i++)
                    {
        ...
        protected override void Draw(GameTime gameTime)
        {
            if (!lockDraw)
            {
                ...
                switch (GameMode)
                {
                    ...
                    case GameModes.RecruitMenuMode:
                        Draw_RecruitMenuMode(gameTime);
                        break;

                    case GameModes.TransitionInRecruitMenuMode:
                        Draw_TransitionInRecruitMenuMode(gameTime);
                        break;
        ...
        private void Draw_SelectionBarMode(GameTime gameTime)
        {
            ...
            neutral_characters.DrawAt(spriteBatch, map, map.Position, false, map.Offset);
            spriteBatch.End();
        }
        ...
        private void Draw_PlayerMoveMode(GameTime gameTime)
        {
            ...
            Blink(gameTime);
            neutral_characters.Draw(spriteBatch, map);
        ...
        private void Draw_PlayerMoveTransitionMode(GameTime gameTime)
        {
            ...
            neutral_characters.Draw(spriteBatch, map, oldMapPosition);
            selectionBar.Draw(spriteBatch, oldSelectionBarPosition);
            spriteBatch.End();
        }
        ...
        private void Draw_TransitionInPlayerMoveTransitionMode(GameTime gameTime)
        {
            ...
            neutral_characters.DrawAt(spriteBatch, map, oldMapPosition, false, map.Offset);
        ...
        private void Draw_LargeCharacterStatsMode(GameTime gameTime)
        {
            ...
            smallFont.Position = new Vector2(160 + 20, 192 + 96);
            ...
            if (whoseStatsToBeDisplayed.BelongsToSide == CharacterPointer.Sides.Player)
            {
                ...
                smallFont.Println(spriteBatch, party.Members[whoseStatsToBeDisplayed.WhichOne].Name);
            ...
            {
                smallFont.Position = largeCharacterStatsMainBox.Position + new Vector2(20, 16);
                smallFont.Println(spriteBatch, enemies.Members[whoseStatsToBeDisplayed.WhichOne].Name);
                smallFont.Println(spriteBatch, "");
        ...
        private void Draw_RecruitMenuMode(GameTime gameTime)
        {
            spriteBatch.Begin();
            map.Draw(spriteBatch, oldMapPosition, true);
            Blink(gameTime);
        ...
        private void Draw_TransitionInRecruitMenuMode(GameTime gameTime)
        {
            spriteBatch.Begin();
            map.Draw(spriteBatch, true);
            Blink(gameTime);
        ...
        private void Draw_BattleFieldFadeOutMode(GameTime gameTime)
        {
            ...
            neutral_characters.DrawAt(spriteBatch, map, map.Position, false, map.Offset, fadingState);
            spriteBatch.End();
        }
        ...
        private void Draw_MemberMenuMode(GameTime gameTime)
        {
            ...
            smallFont.Println(spriteBatch, party.Members[memberMenuState_selectedMemberNumber].Name + " L" + itoa(party.Members[memberMenuState_selectedMemberNumber].LevelToDisplay));
            smallFont.Println(spriteBatch, "");
            smallFont.Println(spriteBatch, "MAGIC     ITEM");
            ...
            for (int i = 0; i < MEMBERMENU_NUMCHARSPERPAGE && memberMenuState_firstMemberNumberToDisplay + i < party.Members.Count; i++)
            {
                smallFont.Println(spriteBatch, "");
            ...
            if (memberMenuState_firstMemberNumberToDisplay + MEMBERMENU_NUMCHARSPERPAGE - 1 < party.Members.Count - 1)
        ...
        private void Draw_TargetCharacterStatsBox()
        {
            ...
            switch (target.BelongsToSide)
            {
                ...
                case CharacterPointer.Sides.Neutral:
                    Draw_CharacterStatsBox(neutral_characters.Members[target.WhichOne], target.BelongsToSide);
                    break;
            }
        ...
        private void Draw_SelectedCharacterStatsBox()
        {
            Vector2 backUpCharacterStatsBoxSize = characterStatsBox.Size;
            Vector2 backUpCharacterStatsBoxPosition = characterStatsBox.Position;
            characterStatsBox.Size = new Vector2(Box.Texture_TopLeft.Width + (party.Members[map.CharacterLocatedAt(selectionBar.PositionInMap(map), party)].Name.Length + 3) * smallFont.Size.X + Box.Texture_TopRight.Width + 10, 80);
            // 2024.12.02 introduced constants
        ...
        private void Blink(GameTime gameTime)
        {
            ...
            if (!blinkDelayReached && elapsedTime >= 1000 / 60 * BLINK_DELAY)
            {
                ...
                if (GameMode == GameModes.SelectionBarMode || GameMode == GameModes.BattleMenuMode || GameMode == GameModes.BattleMenuMoveInMode || GameMode == GameModes.BattleMenuMoveOutMode || GameMode == GameModes.TransitionInSelectionBarMode || GameMode == GameModes.AttackMenuMode || GameMode == GameModes.TransitionInAttackMenuMode || GameMode == GameModes.SelectionBarTransitionOutAttackMenuMode || GameMode == GameModes.ItemMagicSelectionMenuMode || GameMode == GameModes.DisplayTextMessageMode || GameMode == GameModes.PlayerBattleMode || GameMode == GameModes.PlayerBattleDisplayTextMessageMode || GameMode == GameModes.MagicLevelSelectionMode || GameMode == GameModes.HealMenuMode || GameMode == GameModes.RecruitMenuMode || GameMode == GameModes.MemberMenuMode)
                {
        ...
        private void UpdateVariables()
        {
            switch (GameMode)
            {
                ...
                case GameModes.RecruitMenuMode:
                    UpdateVariables_RecruitMenuMode();
                    break;

                case GameModes.TransitionInRecruitMenuMode:
                    UpdateVariables_TransitionInRecruitMenuMode();
                    break;
        ...
        private void UpdateVariables_PlayerBattleMode()
        {
            ...
            switch (battleModeState)
            {
                ...
                case BattleModeStates.DisplayDamageAndCalculateExperiencePoints:
                    battleModeState++;
                    if ((battleMenu.CurrentState == BattleMenu.States.MagicSelected1 || battleMenu.CurrentState == BattleMenu.States.MagicSelected2)
                    ...
                    else
                    {
                                 ...
                                 && selectedMagicSpell.Type == Spell.Types.Heal))
                        {
                            switch (selectedMagicSpell.Name)
                            {
                              ...
                              && selectedMagicSpell.Type == Spell.Types.Recruit)
                        {
                            var newPartyMember = neutral_characters.Members[target.WhichOne];
                            textMessage[0] = newPartyMember.Name + " joins";
                            textMessage[1] = "the force.";
                            textMessageLength = 2;
                            switch (newPartyMember.Name)
                            {
                                case "WARRIOR":
                                    newPartyMember.Texture = Character.TexturesTassi;
                                    break;

                                case "ARCHER":
                                    newPartyMember.Texture = Character.TexturesEva;
                                    break;

                                case "WIZARD":
                                    newPartyMember.Texture = Character.TexturesMonica;
                                    break;
                            }
                            party.Join(newPartyMember);
                            neutral_characters.Members.Remove(newPartyMember);
                ...
                case BattleModeStates.CounterAttackInitialMessage:
                    battleModeState = BattleModeStates.DisplayExperiencePoints;
                ...
                case BattleModeStates.CounterAttackDisplayExperiencePoints:
                    battleModeState++;
                    break;

                case BattleModeStates.DisplayExperiencePoints:
                    battleModeState++;
                    if (party.Members[party.MemberOnTurn].HitPoints > 0)
                    {
                        i = 2;
                         ...
                         || ((battleMenu.CurrentState == BattleMenu.States.ItemSelected1 || battleMenu.CurrentState == BattleMenu.States.ItemSelected2) && selectedMagicSpell.Type == Spell.Types.Attack)))
                    {
                        ...
                        if (opponentDefeated || party.Members[party.MemberOnTurn].HitPoints == 0)
                        {
                            if (enemies.MustSurviveIsDefeated())
                                for (i = 0; i < enemies.Members.Count; i++)
        ...
        private void UpdateVariables_EnemyMoveMode()
        {
            if (enemies.Members[enemies.MemberOnTurn].Position != backUpPosition
                /*&& currentStepNumber < map.bestPath.Count*/ 
                )
            {
        ...
        private void UpdateVariables_EnemyBattleMode()
        {
            ...
            switch (battleModeState)
            {
                ...
                case BattleModeStates.SubtractMagicPoints:
                    battleModeState++;
                    if (enemyBattleMove == BattleMoves.MagicAttack || enemyBattleMove == BattleMoves.MagicHeal || enemyBattleMove == BattleMoves.MagicRecruit)
                ...
                case BattleModeStates.DisplayDamageAndCalculateExperiencePoints:
                    ...
                    else
                    {
                        ...
                        else if (enemyBattleMove == BattleMoves.MagicRecruit)
                        {
                            var newPartyMember = neutral_characters.Members[target.WhichOne];
                            textMessage[0] = newPartyMember.Name + " joins";
                            textMessage[1] = "the enemies.";
                            textMessageLength = 2;

                            switch (newPartyMember.Name)
                            {
                                case "WARRIOR":
                                    newPartyMember.Texture = Character.TexturesBanana;
                                    break;

                                case "ARCHER":
                                    newPartyMember.Texture = Character.TexturesNinja;
                                    break;

                                case "WIZARD":
                                    newPartyMember.Texture = Character.TexturesWitch;
                                    break;
                            }
                            enemies.Join(newPartyMember);
                            neutral_characters.Members.Remove(newPartyMember);
        ...
        private void UpdateVariables_RecruitMenuMode()
        {
            if (oldMapPosition != map.Position)
            {
                map.Offset.X = -Map.TILESIZEX * (oldMapPosition.X - map.Position.X);
                ...
                GameMode = GameModes.TransitionInRecruitMenuMode;
            }
        ...
        private void UpdateVariables_TransitionInRecruitMenuMode()
        {
            bool mapOkay = false;
                ...
                || tempSelectionBarPosition.Y != oldSelectionBarPosition.Y * Map.TILESIZEY + SelectionBar.OFFSETY)
            {
                ...
                GameMode = GameModes.RecruitMenuMode;
        }
        ...
        private void UpdateVariables_BattleFieldFadeOutMode()
        {
            ...
            {
                map = null;
                textMessage[0] = "You won the game. Congratulations!";
                textMessageLength = 1;
...
//                        EnterGeneralMenuMoveInMode();
                ...
                if (!oldState.IsKeyDown(Keys.A) && !oldState.IsKeyDown(Keys.D))
                {
                    ...
                    else
                    {
                        switch (party.Members[party.MemberOnTurn].MagicSpells[selectedSpellNumber].Type)
                        {
                            ...
                            case Spell.Types.Recruit:
                                if (map.AnyCharacterLocatedInMarkedFields(neutral_characters))
                                {
                                    EnterRecruitMenuMode();
                                }
                                else
                                {
                                    textMessage[0] = "No neutral character there.";
                                    textMessageLength = 1;
                                    returnGameMode = GameModes.ItemMagicSelectionMenuMode;
                                    waitForKeyPress = true;
                                    moveOut = true;
        ...
        private void UpdateInput_RecruitMenuMode()
        {
            KeyboardState newState = Keyboard.GetState();
            ...
            if (newState.IsKeyDown(Keys.Right) || newState.IsKeyDown(Keys.Down))
            {
                ...
                {
                    keyHoldCounter = 0;
                    UpdateInput_RecruitMenuMode_CursorKey1();
                }
                else
                {
                    keyHoldCounter++;
            ...
            else if (newState.IsKeyDown(Keys.Left) || newState.IsKeyDown(Keys.Up))
            {
                ...
                {
                    keyHoldCounter = 0;
                    UpdateInput_RecruitMenuMode_CursorKey2();
                }
                else
                {
                    keyHoldCounter++;
        ...
        private void UpdateInput_RecruitMenuMode_CursorKey1()
        {
            skip++;
            if (map.GetNextCharacterPositionLocatedInMarkedFields(neutral_characters, skip) == -1)
                skip = 0;
            UpdateInput_RecruitMenuMode_CursorKey_Common();
        }

        private void UpdateInput_RecruitMenuMode_CursorKey2()
        {
            if (skip == 0)
                while (map.GetNextCharacterPositionLocatedInMarkedFields(neutral_characters, skip) != -1)
                    skip++;
        ...
        private void UpdateInput_RecruitMenuMode_CursorKey_Common()
        {
            selectionBar.Position = map.CalcPosition(map.GetNextCharacterPositionLocatedInMarkedFields(neutral_characters, skip));
            ...
            target = new CharacterPointer(CharacterPointer.Sides.Neutral, map.CharacterLocatedAt(selectionBar.PositionInMap(map), neutral_characters));
        }
        ...
        private void UpdateInput_MemberMenuMode_Down()
        {
            ...
            else if (memberMenuState_selectedMemberNumber < party.Members.Count - 1)
                memberMenuState_selectedMemberNumber++;
        }
...
//            EnterGeneralMenuMode();
        ...
        private void UpdateInput_TitleScreenMode()
        {
            ...
            {
                GameMode = GameModes.AfterTitleScreenMode;
            }
        }
        ...
        private void EnterPlayerMoveMode()
        {
            ...
            {
                GameMode = GameModes.PlayerMoveMode;
                map.CalcViable(party.Members[party.MemberOnTurn].Position, party.Members[party.MemberOnTurn].MovePoints, party.Members[party.MemberOnTurn].Flying, enemies, neutral_characters);
            }
        }
            ...
            switch (battleMenu.CurrentState)
            {
                ...
                case BattleMenu.States.MagicSelected2:
                    switch (selectedMagicSpell.Type)
                    {
                        ...
                        case Spell.Types.Recruit:
                            // **** must be tested
                            targetsAttackedOrHealed[0].WhichOne = map.GetNextCharacterNumberLocatedInMarkedFields(neutral_characters, skip);
                            targetsAttackedOrHealed[0].BelongsToSide = CharacterPointer.Sides.Neutral;
                            MagicRecruit(map.GetNextCharacterPositionLocatedInMarkedFields(neutral_characters, skip), neutral_characters);
                            break;
                    }
                    break;
            }
        ...
        private void EnterEnemyMoveMode()
        {
            ...
            {
                GameMode = GameModes.EnemyMoveMode;
                map.CalcViable(enemies.Members[enemies.MemberOnTurn].Position, enemies.Members[enemies.MemberOnTurn].MovePoints, enemies.Members[enemies.MemberOnTurn].Flying, party, neutral_characters);
                ...
                else
                {
                    ...
                    if (enemyBattleMove == BattleMoves.Stay)
                    {
                        if (enemies.Members[enemies.MemberOnTurn].CanCastRecruitSpell())
                            target = EnterEnemyMoveMode_MagicRecruit();
                    }
                    if (enemyBattleMove == BattleMoves.Stay)
                    {
                        if (enemies.Members[enemies.MemberOnTurn].CanCastAttackSpell())
        ...
        private CharacterPointer EnterEnemyMoveMode_MagicRecruit()
        {
            bool charFound = false;
            int charNumber = -1;
            ...
            {
                if (enemies.Members[enemies.MemberOnTurn].MagicSpells[selectedSpellNumber] != null
                    && enemies.Members[enemies.MemberOnTurn].MagicSpells[selectedSpellNumber].Type == Spell.Types.Recruit)
                {
                    // calculate strongest possible magic level
                    selectedMagicLevel = enemies.Members[enemies.MemberOnTurn].MagicSpells[selectedSpellNumber].Level;
                    bool found = false;
                    ...
                    if (found)
                    {
                        // choose neutral character to Recruit
                        map.EmptyMapMarked();
                        if (map.MarkRecruitableAllies(enemies, neutral_characters, enemies.Members[enemies.MemberOnTurn].MagicSpells[selectedSpellNumber].MinRange[selectedMagicLevel - 1], enemies.Members[enemies.MemberOnTurn].MagicSpells[selectedSpellNumber].MaxRange[selectedMagicLevel - 1]))
                        {
                            charNumber = map.GetNextCharacterNumberLocatedInMarkedFields(neutral_characters, 0);
                            var targetPosition_test = map.GetNextCharacterPositionLocatedInMarkedFields(neutral_characters, skip);
                            if (targetPosition_test != -1)
                            {
                                targetPosition = targetPosition_test;
                                // here comes the code to get the position to which the enemy has to move
                                // this algorithm chooses the closest location to the enemy's current location
                                backUpPosition = map.CalcPositionWhereToMove(enemies, neutral_characters, charNumber, enemies.Members[enemies.MemberOnTurn].MagicSpells[selectedSpellNumber].MinRange[selectedMagicLevel - 1], enemies.Members[enemies.MemberOnTurn].MagicSpells[selectedSpellNumber].MaxRange[selectedMagicLevel - 1]);
                                enemyBattleMove = BattleMoves.MagicRecruit;
                                return new CharacterPointer(CharacterPointer.Sides.Neutral, charNumber);
                            }
                        }
                    }
                }
        ...
        private void EnterEnemyMoveMode_Stay()
        {
                ...
                && enemies.Members[enemies.MemberOnTurn].CanCastHealSpell())
            {
                ...
                map.EmptyMapMarked();
                map.MarkViable();
                map.CalcViableFromMarked(enemies.Members[enemies.MemberOnTurn].MovePoints, enemies.Members[enemies.MemberOnTurn].Flying, party, neutral_characters);
        ...
        private void EnterEnemyBattleMode()
        {
            ...
            switch (enemyBattleMove)
            {
                ...
                case BattleMoves.MagicRecruit:
                    for (int i = selectedMagicSpell.MinRange[selectedMagicLevel - 1]; i <= selectedMagicSpell.MaxRange[selectedMagicLevel - 1]; i++)
                        map.MarkFieldsWithDistance(enemies.Members[enemies.MemberOnTurn].Position, i);
                    MagicRecruit(targetPosition, neutral_characters);
                    break;
            }
        ...
        private void EnterRecruitMenuMode()
        {
            GameMode = GameModes.RecruitMenuMode;
            oldSelectionBarPosition = map.CalcPosition(party.Members[party.MemberOnTurn].Position);
            // select neutral character in proximity
            skip = 0;
            UpdateInput_RecruitMenuMode_CursorKey_Common();
        }
        ...
        private void EnterPlayerAutoMoveMode_StayConfused()
        {
            ...
            map.EmptyMapMarked();
            map.MarkViable();
            map.CalcViableFromMarked(party.Members[party.MemberOnTurn].MovePoints, party.Members[party.MemberOnTurn].Flying, enemies, neutral_characters);
            if (map.MarkAttackableOpponents(party, party, party.Members[party.MemberOnTurn].MinAttackRange, party.Members[party.MemberOnTurn].MaxAttackRange))
            {
                skip = 0;
                int charNumber = -1;
        ...
        private void EnterInitializeBattle1Mode()
        {
            ...
            for (int i = 0; i < party.Members.Count; i++)
            {
                party.Members[i].Position = map.GetStartingPositionOfPartyMember(party, i);
            }

            var numEnemies = map.GetNumberOfEnemies();
            enemies = new Party(CharacterPointer.Sides.CPU_Opponents);

            for (int i = 0; i < numEnemies; i++)
            {
                enemies.Members.Add(new Character(map.GetEnemyId(i), CharacterPointer.Sides.CPU_Opponents));
                enemies.Members[i].Position = map.GetStartingPositionOfPartyMember(enemies, i);
                ...
                do
                {
                    ...
                    {
                        if (party.Members[j].Position == enemies.Members[i].Position)
                        {
                            needs_repeat = true;
                            break;
                        }
                    ...
                    if (needs_repeat)
                    {
                        map.AdjustPartyMemberPosition(enemies, i);
                        if (enemies.Members[i].Position >= map.Size.X * map.Size.Y)
                        {
                            enemies.Members[i].Position = 0;
                        }
                    }
                } while (needs_repeat);
            }
            ...
            var rnd = map.Rnd;
            neutral_characters = new Party(CharacterPointer.Sides.Neutral);
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                {
                    case 0:
                        neutral_characters.Members.Add(new Character("N.WARRIOR"));
                        break;

                    case 1:
                        neutral_characters.Members.Add(new Character("N.ARCHER"));
                        break;

                    case 2:
                        neutral_characters.Members.Add(new Character("N.WIZARD"));
                        break;
                }
                neutral_characters.Members[i].Position = map.GetStartingPositionOfPartyMember(neutral_characters, i);
                var needs_repeat = false;
                do
                {
                    needs_repeat = false;
                    ...
                    for (var j = 0; j < party.Members.Count; j++)
                    {
                        if (party.Members[j].Position == neutral_characters.Members[i].Position)
                        {
                            needs_repeat = true;
                            break;
                        }
                    ...
                    if (!needs_repeat)
                    {
                        for (var j = 0; j < enemies.Members.Count; j++)
                        {
                            if (enemies.Members[j].Position == neutral_characters.Members[i].Position)
                            {
                                needs_repeat = true;
                                break;
                            }
                    ...
                    if (needs_repeat)
                    {
                        map.AdjustPartyMemberPosition(neutral_characters, i);
                        if (neutral_characters.Members[i].Position >= map.Size.X * map.Size.Y)
                        {
                            neutral_characters.Members[i].Position = 0;
                        }
                    }
                } while (needs_repeat);
            }
            ...
            if (characterPointer.BelongsToSide == CharacterPointer.Sides.Player)
            {
                map.Position = mapPositionPlayerMoveMode[characterPointer.WhichOne];
                selectionBar.Position = map.CalcPosition(party.Members[characterPointer.WhichOne].Position);
            }
            else
            {
                map.Position = mapPositionEnemyMoveMode[characterPointer.WhichOne];
        ...
        private void EnterMemberMenuMode()
        {
            ...
            memberMenuDisplayStatsBox.Size = new Vector2(600, 208);
            // 2024.12.02 introduced constants and fixed the position logics
            memberMenuCharacterSelectionBox.Size = new Vector2(memberMenuDisplayStatsBox.Size.X, (Game1.PREFERREDBACKBUFFERHEIGHT - 184) / 2);
            memberMenuDisplayStatsBox.Position = new Vector2((Game1.PREFERREDBACKBUFFERWIDTH - memberMenuDisplayStatsBox.Size.X) / 2, (Game1.PREFERREDBACKBUFFERHEIGHT - memberMenuDisplayStatsBox.Size.Y - memberMenuCharacterSelectionBox.Size.Y) / 2);
            memberMenuCharacterSelectionBox.Position = new Vector2((Game1.PREFERREDBACKBUFFERWIDTH - memberMenuDisplayStatsBox.Size.X) / 2, (Game1.PREFERREDBACKBUFFERHEIGHT - memberMenuDisplayStatsBox.Size.Y - memberMenuCharacterSelectionBox.Size.Y) / 2 + memberMenuDisplayStatsBox.Size.Y);
        }
        ...
        private void MagicRecruit(int center, Party party1)
        {
            MagicAttack(center, party1);
        }
